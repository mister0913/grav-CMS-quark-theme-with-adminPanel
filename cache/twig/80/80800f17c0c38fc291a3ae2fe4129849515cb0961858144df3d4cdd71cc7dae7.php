...
class __TwigTemplate_bab73ca34a7b5fa608f7d67b561bab48e8d497c1d3e01677c2cc867d005fb8e4 extends \Twig\Template
{
...
";
        ...
        if (($context["favicon"] ?? null)) {
            ...
            echo twig_escape_filter($this->env, $this->env->getExtension('Grav\Common\Twig\Extension\GravExtension')->urlFunc(("theme://img/" . ($context["favicon"] ?? null))), "html", null, true);
            echo "\">
";
        }
        // line 11
...
{% endblock %}
{% endblock head %}
", "partials/head.html.twig", "D:\\Workspace\\Grav CMS\\grav-skeleton-onepage-site+admin-2.0.0\\user\\themes\\x-corporation\\templates\\partials\\head.html.twig");
    }
}
